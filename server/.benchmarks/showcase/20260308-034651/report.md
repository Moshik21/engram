...
- Mode: `quick`
- Seeds: `7`
- Generated: `2026-03-08T03:46:51+00:00`

## Executive Table

| Baseline | Available | Pass Rate | Temporal | Open Loop | Prospective | False Recall | p50 ms | p95 ms | Selective Extraction |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Engram Full | yes | 0.750 | 1.000 | 0.000 | 1.000 | 0.000 | 4.101 | 4.190 | 0.545 |
| Context Window | yes | 0.000 | 0.000 | 0.000 | 0.000 | 0.200 | 0.026 | 0.052 | 0.000 |
| Markdown Memory | yes | 0.000 | 0.000 | 0.000 | 0.000 | 0.200 | 0.017 | 0.041 | 0.000 |
| Vector RAG | yes | 0.000 | 0.000 | 0.000 | 0.000 | 0.200 | 13.858 | 15.451 | 0.000 |
...
- Context Window: pass_rate=0.000, avg_tokens=102.000, avg_latency_ms=0.056
- Engram Full: pass_rate=0.000, avg_tokens=67.000, avg_latency_ms=3.469
- Markdown Memory: pass_rate=0.000, avg_tokens=112.000, avg_latency_ms=0.046
- Vector RAG: pass_rate=0.000, avg_tokens=102.000, avg_latency_ms=13.858
...
- Engram Full: pass_rate=1.000, avg_tokens=59.000, avg_latency_ms=4.187
- Markdown Memory: pass_rate=0.000, avg_tokens=38.000, avg_latency_ms=0.011
- Vector RAG: pass_rate=0.000, avg_tokens=34.000, avg_latency_ms=9.250
...
- Engram Full: pass_rate=1.000, avg_tokens=197.000, avg_latency_ms=4.028
- Markdown Memory: pass_rate=0.000, avg_tokens=74.000, avg_latency_ms=0.019
- Vector RAG: pass_rate=0.000, avg_tokens=64.000, avg_latency_ms=7.889
...
- Engram Full: pass_rate=1.000, avg_tokens=96.000, avg_latency_ms=4.101
- Markdown Memory: pass_rate=0.000, avg_tokens=26.000, avg_latency_ms=0.017
- Vector RAG: pass_rate=0.000, avg_tokens=22.000, avg_latency_ms=14.383
