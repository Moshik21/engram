...
QUERY find_entities_all() =>
    entities <- N<Entity>::WHERE(_::{is_deleted}::EQ(false))
    RETURN entities
...
QUERY find_entities_by_name_all(name_query: String) =>
    entities <- N<Entity>::WHERE(AND(_::{name}::CONTAINS(name_query), _::{is_deleted}::EQ(false)))
    RETURN entities
...
QUERY find_entities_by_type_all(etype: String) =>
    entities <- N<Entity>::WHERE(AND(_::{entity_type}::EQ(etype), _::{is_deleted}::EQ(false)))
    RETURN entities
...
QUERY find_entities_by_name_and_type_all(name_query: String, etype: String) =>
    entities <- N<Entity>::WHERE(AND(_::{name}::CONTAINS(name_query), _::{entity_type}::EQ(etype), _::{is_deleted}::EQ(false)))
    RETURN entities
...
QUERY create_episode_cue(episode_id: String, group_id: String, cue_version: I32, discourse_class: String, cue_text: String, supporting_spans_json: String, temporal_markers_json: String, quote_spans_json: String, contradiction_keys_json: String, first_spans_json: String, projection_state: String, cue_score: F64, salience_score: F64, projection_priority: F64, route_reason: String, hit_count: I32, surfaced_count: I32, selected_count: I32, used_count: I32, near_miss_count: I32, policy_score: F64, projection_attempts: I32, last_hit_at: String, last_feedback_at: String, last_projected_at: String, created_at: String, updated_at: String) =>
    node <- AddN<EpisodeCue>({episode_id: episode_id, group_id: group_id, cue_version: cue_version, discourse_class: discourse_class, cue_text: cue_text, supporting_spans_json: supporting_spans_json, temporal_markers_json: temporal_markers_json, quote_spans_json: quote_spans_json, contradiction_keys_json: contradiction_keys_json, first_spans_json: first_spans_json, projection_state: projection_state, cue_score: cue_score, salience_score: salience_score, projection_priority: projection_priority, route_reason: route_reason, hit_count: hit_count, surfaced_count: surfaced_count, selected_count: selected_count, used_count: used_count, near_miss_count: near_miss_count, policy_score: policy_score, projection_attempts: projection_attempts, last_hit_at: last_hit_at, last_feedback_at: last_feedback_at, last_projected_at: last_projected_at, created_at: created_at, updated_at: updated_at})
    RETURN node
...
QUERY update_cue(id: ID, cue_version: I32, discourse_class: String, cue_text: String, supporting_spans_json: String, temporal_markers_json: String, quote_spans_json: String, contradiction_keys_json: String, first_spans_json: String, projection_state: String, cue_score: F64, salience_score: F64, projection_priority: F64, route_reason: String, hit_count: I32, surfaced_count: I32, selected_count: I32, used_count: I32, near_miss_count: I32, policy_score: F64, projection_attempts: I32, last_hit_at: String, last_feedback_at: String, last_projected_at: String, updated_at: String) =>
    cue <- N<EpisodeCue>(id)
        ::UPDATE({cue_version: cue_version, discourse_class: discourse_class, cue_text: cue_text, supporting_spans_json: supporting_spans_json, temporal_markers_json: temporal_markers_json, quote_spans_json: quote_spans_json, contradiction_keys_json: contradiction_keys_json, first_spans_json: first_spans_json, projection_state: projection_state, cue_score: cue_score, salience_score: salience_score, projection_priority: projection_priority, route_reason: route_reason, hit_count: hit_count, surfaced_count: surfaced_count, selected_count: selected_count, used_count: used_count, near_miss_count: near_miss_count, policy_score: policy_score, projection_attempts: projection_attempts, last_hit_at: last_hit_at, last_feedback_at: last_feedback_at, last_projected_at: last_projected_at, updated_at: updated_at})
    RETURN cue

QUERY update_cue_by_episode(ep_id: String, gid: String, cue_version: I32, discourse_class: String, cue_text: String, supporting_spans_json: String, temporal_markers_json: String, quote_spans_json: String, contradiction_keys_json: String, first_spans_json: String, projection_state: String, cue_score: F64, salience_score: F64, projection_priority: F64, route_reason: String, hit_count: I32, surfaced_count: I32, selected_count: I32, used_count: I32, near_miss_count: I32, policy_score: F64, projection_attempts: I32, last_hit_at: String, last_feedback_at: String, last_projected_at: String, updated_at: String) =>
    cue <- N<EpisodeCue>::WHERE(AND(_::{episode_id}::EQ(ep_id), _::{group_id}::EQ(gid)))
        ::UPDATE({cue_version: cue_version, discourse_class: discourse_class, cue_text: cue_text, supporting_spans_json: supporting_spans_json, temporal_markers_json: temporal_markers_json, quote_spans_json: quote_spans_json, contradiction_keys_json: contradiction_keys_json, first_spans_json: first_spans_json, projection_state: projection_state, cue_score: cue_score, salience_score: salience_score, projection_priority: projection_priority, route_reason: route_reason, hit_count: hit_count, surfaced_count: surfaced_count, selected_count: selected_count, used_count: used_count, near_miss_count: near_miss_count, policy_score: policy_score, projection_attempts: projection_attempts, last_hit_at: last_hit_at, last_feedback_at: last_feedback_at, last_projected_at: last_projected_at, updated_at: updated_at})
    RETURN cue
...
QUERY find_evidence_by_status(gid: String, st: String) =>
    evidence <- N<Evidence>::WHERE(AND(_::{group_id}::EQ(gid), _::{status}::EQ(st)))
    RETURN evidence
...
QUERY find_adjudications_by_status(gid: String, st: String) =>
    requests <- N<AdjudicationRequest>::WHERE(AND(_::{group_id}::EQ(gid), _::{status}::EQ(st)))
    RETURN requests
