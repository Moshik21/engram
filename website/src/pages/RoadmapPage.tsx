...
const PHASES = [
  {
    ...
    items: [
      ...
      "Capture -> Cue -> Project -> Recall -> Consolidate lifecycle",
      "17-phase offline consolidation",
      "MCP server integration with adoption guidance",
      "Native Helix/PyO3 primary path",
      "SQLite lite fallback + Docker compatibility mode",
      "OpenClaw release path",
      "Operator-visible storage diagnostics",
