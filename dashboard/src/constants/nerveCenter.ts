...
export const EVENT_FLAVOR_TEXT: Record<string, { text: string; plasticity: number }> = {
  ...
  "consolidation.phase.schema.completed": { text: "Cognitive pattern crystallized!", plasticity: 10 },
  "consolidation.phase.mature.completed": { text: "Synaptic connections deepened.", plasticity: 5 },
