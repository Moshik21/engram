...
.filter_ref(|val, txn|{
                if let Ok(val) = val {
                    ...
                    .get_property("group_id")
                    .map_or(false, |v| *v == data.gid.clone()) && val
                    .get_property("cue_text")
                    .map_or(false, |v| *v != "".to_string())))
                } else {
                    Ok(false)
                }
            }).count_to_val();
...
.add_n("ConsolIdentifierReview", Some(ImmutablePropertiesMap::new(20, vec![("review_id", Value::from(&data.review_id)), ("decision_source", Value::from(&data.decision_source)), ("adjusted_similarity", Value::from(&data.adjusted_similarity)), ("entity_b_name", Value::from(&data.entity_b_name)), ("entity_a_name", Value::from(&data.entity_a_name)), ("decision_reason", Value::from(&data.decision_reason)), ("entity_b_regime", Value::from(&data.entity_b_regime)), ("entity_b_id", Value::from(&data.entity_b_id)), ("timestamp", Value::from(&data.timestamp)), ("review_status", Value::from(&data.review_status)), ("entity_a_regime", Value::from(&data.entity_a_regime)), ("entity_a_type", Value::from(&data.entity_a_type)), ("canonical_identifier_a", Value::from(&data.canonical_identifier_a)), ("raw_similarity", Value::from(&data.raw_similarity)), ("group_id", Value::from(&data.group_id)), ("entity_a_id", Value::from(&data.entity_a_id)), ("canonical_identifier_b", Value::from(&data.canonical_identifier_b)), ("entity_b_type", Value::from(&data.entity_b_type)), ("metadata_json", Value::from(&data.metadata_json)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolCalibration", Some(ImmutablePropertiesMap::new(14, vec![("total_traces", Value::from(&data.total_traces)), ("accuracy", Value::from(&data.accuracy)), ("calibration_id", Value::from(&data.calibration_id)), ("window_cycles", Value::from(&data.window_cycles)), ("abstain_count", Value::from(&data.abstain_count)), ("labeled_examples", Value::from(&data.labeled_examples)), ("phase", Value::from(&data.phase)), ("expected_calibration_error", Value::from(&data.expected_calibration_error)), ("group_id", Value::from(&data.group_id)), ("mean_confidence", Value::from(&data.mean_confidence)), ("timestamp", Value::from(&data.timestamp)), ("summary_json", Value::from(&data.summary_json)), ("cycle_id", Value::from(&data.cycle_id)), ("oracle_examples", Value::from(&data.oracle_examples))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolReindex", Some(ImmutablePropertiesMap::new(7, vec![("timestamp", Value::from(&data.timestamp)), ("reindex_id", Value::from(&data.reindex_id)), ("entity_id", Value::from(&data.entity_id)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("entity_name", Value::from(&data.entity_name)), ("source_phase", Value::from(&data.source_phase))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolMerge", Some(ImmutablePropertiesMap::new(13, vec![("relationships_transferred", Value::from(&data.relationships_transferred)), ("timestamp", Value::from(&data.timestamp)), ("keep_name", Value::from(&data.keep_name)), ("similarity", Value::from(&data.similarity)), ("decision_reason", Value::from(&data.decision_reason)), ("cycle_id", Value::from(&data.cycle_id)), ("decision_source", Value::from(&data.decision_source)), ("group_id", Value::from(&data.group_id)), ("keep_id", Value::from(&data.keep_id)), ("remove_id", Value::from(&data.remove_id)), ("remove_name", Value::from(&data.remove_name)), ("merge_id", Value::from(&data.merge_id)), ("decision_confidence", Value::from(&data.decision_confidence))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Episode", Some(ImmutablePropertiesMap::new(22, vec![("last_projection_reason", Value::from(&data.last_projection_reason)), ("consolidation_cycles", Value::from(&data.consolidation_cycles)), ("created_at", Value::from(&data.created_at)), ("updated_at", Value::from(&data.updated_at)), ("content", Value::from(&data.content)), ("episode_id", Value::from(&data.episode_id)), ("last_projected_at", Value::from(&data.last_projected_at)), ("skipped_triage", Value::from(&data.skipped_triage)), ("attachments_json", Value::from(&data.attachments_json)), ("skipped_meta", Value::from(&data.skipped_meta)), ("group_id", Value::from(&data.group_id)), ("encoding_context_json", Value::from(&data.encoding_context_json)), ("session_id", Value::from(&data.session_id)), ("entity_coverage", Value::from(&data.entity_coverage)), ("error", Value::from(&data.error)), ("retry_count", Value::from(&data.retry_count)), ("memory_tier", Value::from(&data.memory_tier)), ("status", Value::from(&data.status)), ("projection_state", Value::from(&data.projection_state)), ("processing_duration_ms", Value::from(&data.processing_duration_ms)), ("conversation_date", Value::from(&data.conversation_date)), ("source", Value::from(&data.source))].into_iter(), &arena)), Some(&["group_id", "status", "session_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolSchema", Some(ImmutablePropertiesMap::new(9, vec![("cycle_id", Value::from(&data.cycle_id)), ("schema_entity_id", Value::from(&data.schema_entity_id)), ("schema_id", Value::from(&data.schema_id)), ("predicate_count", Value::from(&data.predicate_count)), ("action", Value::from(&data.action)), ("group_id", Value::from(&data.group_id)), ("instance_count", Value::from(&data.instance_count)), ("schema_name", Value::from(&data.schema_name)), ("timestamp", Value::from(&data.timestamp))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDecisionTrace", Some(ImmutablePropertiesMap::new(15, vec![("metadata_json", Value::from(&data.metadata_json)), ("trace_id", Value::from(&data.trace_id)), ("timestamp", Value::from(&data.timestamp)), ("group_id", Value::from(&data.group_id)), ("candidate_id", Value::from(&data.candidate_id)), ("confidence", Value::from(&data.confidence)), ("decision_source", Value::from(&data.decision_source)), ("phase", Value::from(&data.phase)), ("cycle_id", Value::from(&data.cycle_id)), ("candidate_type", Value::from(&data.candidate_type)), ("threshold_band", Value::from(&data.threshold_band)), ("policy_version", Value::from(&data.policy_version)), ("decision", Value::from(&data.decision)), ("features_json", Value::from(&data.features_json)), ("constraints_json", Value::from(&data.constraints_json))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConversationMessage", Some(ImmutablePropertiesMap::new(6, vec![("role", Value::from(&data.role)), ("parts_json", Value::from(&data.parts_json)), ("conversation_id", Value::from(&data.conversation_id)), ("content", Value::from(&data.content)), ("created_at", Value::from(&data.created_at)), ("message_id", Value::from(&data.message_id))].into_iter(), &arena)), Some(&["conversation_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Entity", Some(ImmutablePropertiesMap::new(24, vec![("lexical_regime", Value::from(&data.lexical_regime)), ("name", Value::from(&data.name)), ("last_accessed", Value::from(&data.last_accessed)), ("pii_detected", Value::from(&data.pii_detected)), ("source_episode_ids", Value::from(&data.source_episode_ids)), ("deleted_at", Value::from(&data.deleted_at)), ("evidence_count", Value::from(&data.evidence_count)), ("recon_count", Value::from(&data.recon_count)), ("mat_tier", Value::from(&data.mat_tier)), ("identifier_label", Value::from(&data.identifier_label)), ("pii_categories_json", Value::from(&data.pii_categories_json)), ("evidence_span_start", Value::from(&data.evidence_span_start)), ("attributes_json", Value::from(&data.attributes_json)), ("summary", Value::from(&data.summary)), ("entity_type", Value::from(&data.entity_type)), ("identity_core", Value::from(&data.identity_core)), ("canonical_identifier", Value::from(&data.canonical_identifier)), ("group_id", Value::from(&data.group_id)), ("is_deleted", Value::from(&data.is_deleted)), ("evidence_span_end", Value::from(&data.evidence_span_end)), ("access_count", Value::from(&data.access_count)), ("entity_id", Value::from(&data.entity_id)), ("created_at", Value::from(&data.created_at)), ("updated_at", Value::from(&data.updated_at))].into_iter(), &arena)), Some(&["name", "group_id", "entity_type", "canonical_identifier"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasSnapshot", Some(ImmutablePropertiesMap::new(13, vec![("represented_entity_count", Value::from(&data.represented_entity_count)), ("represented_edge_count", Value::from(&data.represented_edge_count)), ("generated_at", Value::from(&data.generated_at)), ("displayed_node_count", Value::from(&data.displayed_node_count)), ("total_entities", Value::from(&data.total_entities)), ("truncated", Value::from(&data.truncated)), ("hottest_region_id", Value::from(&data.hottest_region_id)), ("total_relationships", Value::from(&data.total_relationships)), ("group_id", Value::from(&data.group_id)), ("total_regions", Value::from(&data.total_regions)), ("snapshot_id", Value::from(&data.snapshot_id)), ("fastest_growing_region_id", Value::from(&data.fastest_growing_region_id)), ("displayed_edge_count", Value::from(&data.displayed_edge_count))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolInferredEdge", Some(ImmutablePropertiesMap::new(14, vec![("group_id", Value::from(&data.group_id)), ("infer_type", Value::from(&data.infer_type)), ("confidence", Value::from(&data.confidence)), ("relationship_id", Value::from(&data.relationship_id)), ("llm_verdict", Value::from(&data.llm_verdict)), ("pmi_score", Value::from(&data.pmi_score)), ("co_occurrence_count", Value::from(&data.co_occurrence_count)), ("edge_id", Value::from(&data.edge_id)), ("target_id", Value::from(&data.target_id)), ("source_id", Value::from(&data.source_id)), ("source_name", Value::from(&data.source_name)), ("timestamp", Value::from(&data.timestamp)), ("target_name", Value::from(&data.target_name)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolMaturation", Some(ImmutablePropertiesMap::new(13, vec![("maturity_score", Value::from(&data.maturity_score)), ("mat_id", Value::from(&data.mat_id)), ("group_id", Value::from(&data.group_id)), ("entity_name", Value::from(&data.entity_name)), ("cycle_id", Value::from(&data.cycle_id)), ("access_regularity", Value::from(&data.access_regularity)), ("temporal_span_days", Value::from(&data.temporal_span_days)), ("new_tier", Value::from(&data.new_tier)), ("source_diversity", Value::from(&data.source_diversity)), ("old_tier", Value::from(&data.old_tier)), ("relationship_richness", Value::from(&data.relationship_richness)), ("timestamp", Value::from(&data.timestamp)), ("entity_id", Value::from(&data.entity_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegionMember", Some(ImmutablePropertiesMap::new(4, vec![("entity_id", Value::from(&data.entity_id)), ("group_id", Value::from(&data.group_id)), ("region_id", Value::from(&data.region_id)), ("snapshot_id", Value::from(&data.snapshot_id))].into_iter(), &arena)), Some(&["snapshot_id", "group_id", "region_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "EntityVec", Some(ImmutablePropertiesMap::new(5, vec![("entity_id", Value::from(data.entity_id.clone())), ("embed_model", Value::from(data.embed_model.clone())), ("content_type", Value::from(data.content_type.clone())), ("embed_provider", Value::from(data.embed_provider.clone())), ("group_id", Value::from(data.group_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDecisionOutcome", Some(ImmutablePropertiesMap::new(10, vec![("decision_trace_id", Value::from(&data.decision_trace_id)), ("outcome_label", Value::from(&data.outcome_label)), ("outcome_id", Value::from(&data.outcome_id)), ("group_id", Value::from(&data.group_id)), ("metadata_json", Value::from(&data.metadata_json)), ("outcome_value", Value::from(&data.outcome_value)), ("outcome_type", Value::from(&data.outcome_type)), ("phase", Value::from(&data.phase)), ("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let edge = G::new_mut(&db, &arena, &mut txn)
.add_edge("RelatesTo", Some(ImmutablePropertiesMap::new(10, vec![("valid_from", Value::from(data.valid_from.clone())), ("group_id", Value::from(data.group_id.clone())), ("is_expired", Value::from(data.is_expired.clone())), ("source_episode_id", Value::from(data.source_episode_id.clone())), ("weight", Value::from(data.weight.clone())), ("polarity", Value::from(data.polarity.clone())), ("valid_to", Value::from(data.valid_to.clone())), ("predicate", Value::from(data.predicate.clone())), ("created_at", Value::from(data.created_at.clone())), ("rel_id", Value::from(data.rel_id.clone()))].into_iter(), &arena)), *data.source_id, *data.target_id, false, false).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Evidence", Some(ImmutablePropertiesMap::new(19, vec![("evidence_id", Value::from(&data.evidence_id)), ("resolved_at", Value::from(&data.resolved_at)), ("group_id", Value::from(&data.group_id)), ("signals_json", Value::from(&data.signals_json)), ("deferred_cycles", Value::from(&data.deferred_cycles)), ("ambiguity_score", Value::from(&data.ambiguity_score)), ("adjudication_request_id", Value::from(&data.adjudication_request_id)), ("source_type", Value::from(&data.source_type)), ("fact_class", Value::from(&data.fact_class)), ("source_span", Value::from(&data.source_span)), ("committed_id", Value::from(&data.committed_id)), ("status", Value::from(&data.status)), ("created_at", Value::from(&data.created_at)), ("extractor_name", Value::from(&data.extractor_name)), ("payload_json", Value::from(&data.payload_json)), ("episode_id", Value::from(&data.episode_id)), ("ambiguity_tags_json", Value::from(&data.ambiguity_tags_json)), ("confidence", Value::from(&data.confidence)), ("commit_reason", Value::from(&data.commit_reason))].into_iter(), &arena)), Some(&["episode_id", "group_id", "status"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "EpisodeVec", Some(ImmutablePropertiesMap::new(3, vec![("episode_id", Value::from(data.episode_id.clone())), ("group_id", Value::from(data.group_id.clone())), ("content_type", Value::from(data.content_type.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ComplementTag", Some(ImmutablePropertiesMap::new(10, vec![("updated_at", Value::from(&data.updated_at)), ("created_at", Value::from(&data.created_at)), ("group_id", Value::from(&data.group_id)), ("cycle_tagged", Value::from(&data.cycle_tagged)), ("cleared", Value::from(&data.cleared)), ("score", Value::from(&data.score)), ("tag_type", Value::from(&data.tag_type)), ("target_id", Value::from(&data.target_id)), ("target_type", Value::from(&data.target_type)), ("cycle_confirmed", Value::from(&data.cycle_confirmed))].into_iter(), &arena)), Some(&["target_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolReplay", Some(ImmutablePropertiesMap::new(9, vec![("new_entities_found", Value::from(&data.new_entities_found)), ("new_relationships_found", Value::from(&data.new_relationships_found)), ("skipped_reason", Value::from(&data.skipped_reason)), ("group_id", Value::from(&data.group_id)), ("replay_id", Value::from(&data.replay_id)), ("cycle_id", Value::from(&data.cycle_id)), ("episode_id", Value::from(&data.episode_id)), ("entities_updated", Value::from(&data.entities_updated)), ("timestamp", Value::from(&data.timestamp))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolEvidenceAdj", Some(ImmutablePropertiesMap::new(8, vec![("reason", Value::from(&data.reason)), ("group_id", Value::from(&data.group_id)), ("evidence_id", Value::from(&data.evidence_id)), ("adj_id", Value::from(&data.adj_id)), ("action", Value::from(&data.action)), ("cycle_id", Value::from(&data.cycle_id)), ("timestamp", Value::from(&data.timestamp)), ("new_confidence", Value::from(&data.new_confidence))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Intention", Some(ImmutablePropertiesMap::new(13, vec![("max_fires", Value::from(&data.max_fires)), ("fire_count", Value::from(&data.fire_count)), ("group_id", Value::from(&data.group_id)), ("intention_id", Value::from(&data.intention_id)), ("created_at", Value::from(&data.created_at)), ("enabled", Value::from(&data.enabled)), ("deleted_at", Value::from(&data.deleted_at)), ("is_deleted", Value::from(&data.is_deleted)), ("action_text", Value::from(&data.action_text)), ("updated_at", Value::from(&data.updated_at)), ("trigger_text", Value::from(&data.trigger_text)), ("context_json", Value::from(&data.context_json)), ("entity_names_json", Value::from(&data.entity_names_json))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolGraphEmbed", Some(ImmutablePropertiesMap::new(9, vec![("full_retrain", Value::from(&data.full_retrain)), ("training_duration_ms", Value::from(&data.training_duration_ms)), ("dimensions", Value::from(&data.dimensions)), ("entities_trained", Value::from(&data.entities_trained)), ("embed_id", Value::from(&data.embed_id)), ("group_id", Value::from(&data.group_id)), ("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id)), ("method", Value::from(&data.method))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolMicroglia", Some(ImmutablePropertiesMap::new(10, vec![("detail", Value::from(&data.detail)), ("target_type", Value::from(&data.target_type)), ("cycle_id", Value::from(&data.cycle_id)), ("target_id", Value::from(&data.target_id)), ("microglia_id", Value::from(&data.microglia_id)), ("action", Value::from(&data.action)), ("timestamp", Value::from(&data.timestamp)), ("tag_type", Value::from(&data.tag_type)), ("score", Value::from(&data.score)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDistillation", Some(ImmutablePropertiesMap::new(16, vec![("teacher_label", Value::from(&data.teacher_label)), ("decision_trace_id", Value::from(&data.decision_trace_id)), ("metadata_json", Value::from(&data.metadata_json)), ("features_json", Value::from(&data.features_json)), ("student_decision", Value::from(&data.student_decision)), ("group_id", Value::from(&data.group_id)), ("threshold_band", Value::from(&data.threshold_band)), ("candidate_type", Value::from(&data.candidate_type)), ("student_confidence", Value::from(&data.student_confidence)), ("teacher_source", Value::from(&data.teacher_source)), ("distill_id", Value::from(&data.distill_id)), ("correct", Value::from(&data.correct)), ("timestamp", Value::from(&data.timestamp)), ("phase", Value::from(&data.phase)), ("cycle_id", Value::from(&data.cycle_id)), ("candidate_id", Value::from(&data.candidate_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolTriage", Some(ImmutablePropertiesMap::new(8, vec![("group_id", Value::from(&data.group_id)), ("decision", Value::from(&data.decision)), ("episode_id", Value::from(&data.episode_id)), ("triage_id", Value::from(&data.triage_id)), ("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id)), ("score_breakdown_json", Value::from(&data.score_breakdown_json)), ("score", Value::from(&data.score))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolPrune", Some(ImmutablePropertiesMap::new(8, vec![("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id)), ("prune_id", Value::from(&data.prune_id)), ("group_id", Value::from(&data.group_id)), ("reason", Value::from(&data.reason)), ("entity_id", Value::from(&data.entity_id)), ("entity_name", Value::from(&data.entity_name)), ("entity_type", Value::from(&data.entity_type))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "EpisodeChunk", Some(ImmutablePropertiesMap::new(5, vec![("group_id", Value::from(data.group_id.clone())), ("chunk_text", Value::from(data.chunk_text.clone())), ("content_type", Value::from(data.content_type.clone())), ("episode_id", Value::from(data.episode_id.clone())), ("chunk_index", Value::from(data.chunk_index.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolCycle", Some(ImmutablePropertiesMap::new(10, vec![("dry_run", Value::from(&data.dry_run)), ("error", Value::from(&data.error)), ("cycle_id", Value::from(&data.cycle_id)), ("total_duration_ms", Value::from(&data.total_duration_ms)), ("phase_results_json", Value::from(&data.phase_results_json)), ("started_at", Value::from(&data.started_at)), ("group_id", Value::from(&data.group_id)), ("completed_at", Value::from(&data.completed_at)), ("status", Value::from(&data.status)), ("trigger", Value::from(&data.trigger))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegion", Some(ImmutablePropertiesMap::new(18, vec![("z", Value::from(&data.z)), ("latest_entity_created_at", Value::from(&data.latest_entity_created_at)), ("growth_30d", Value::from(&data.growth_30d)), ("member_count", Value::from(&data.member_count)), ("snapshot_id", Value::from(&data.snapshot_id)), ("subtitle", Value::from(&data.subtitle)), ("represented_edge_count", Value::from(&data.represented_edge_count)), ("group_id", Value::from(&data.group_id)), ("dominant_entity_types_json", Value::from(&data.dominant_entity_types_json)), ("x", Value::from(&data.x)), ("region_id", Value::from(&data.region_id)), ("kind", Value::from(&data.kind)), ("region_label", Value::from(&data.region_label)), ("y", Value::from(&data.y)), ("activation_score", Value::from(&data.activation_score)), ("growth_7d", Value::from(&data.growth_7d)), ("center_entity_id", Value::from(&data.center_entity_id)), ("hub_entity_ids_json", Value::from(&data.hub_entity_ids_json))].into_iter(), &arena)), Some(&["snapshot_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolSemanticTransition", Some(ImmutablePropertiesMap::new(9, vec![("old_tier", Value::from(&data.old_tier)), ("new_tier", Value::from(&data.new_tier)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("entity_coverage", Value::from(&data.entity_coverage)), ("trans_id", Value::from(&data.trans_id)), ("timestamp", Value::from(&data.timestamp)), ("consolidation_cycles", Value::from(&data.consolidation_cycles)), ("episode_id", Value::from(&data.episode_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AdjudicationRequest", Some(ImmutablePropertiesMap::new(13, vec![("resolution_payload_json", Value::from(&data.resolution_payload_json)), ("attempt_count", Value::from(&data.attempt_count)), ("request_id", Value::from(&data.request_id)), ("status", Value::from(&data.status)), ("group_id", Value::from(&data.group_id)), ("created_at", Value::from(&data.created_at)), ("selected_text", Value::from(&data.selected_text)), ("ambiguity_tags_json", Value::from(&data.ambiguity_tags_json)), ("episode_id", Value::from(&data.episode_id)), ("request_reason", Value::from(&data.request_reason)), ("evidence_ids_json", Value::from(&data.evidence_ids_json)), ("resolution_source", Value::from(&data.resolution_source)), ("resolved_at", Value::from(&data.resolved_at))].into_iter(), &arena)), Some(&["episode_id", "group_id", "status"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Conversation", Some(ImmutablePropertiesMap::new(6, vec![("updated_at", Value::from(&data.updated_at)), ("created_at", Value::from(&data.created_at)), ("group_id", Value::from(&data.group_id)), ("conversation_id", Value::from(&data.conversation_id)), ("session_date", Value::from(&data.session_date)), ("title", Value::from(&data.title))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDream", Some(ImmutablePropertiesMap::new(8, vec![("dream_id", Value::from(&data.dream_id)), ("group_id", Value::from(&data.group_id)), ("source_entity_id", Value::from(&data.source_entity_id)), ("weight_delta", Value::from(&data.weight_delta)), ("cycle_id", Value::from(&data.cycle_id)), ("timestamp", Value::from(&data.timestamp)), ("target_entity_id", Value::from(&data.target_entity_id)), ("seed_entity_id", Value::from(&data.seed_entity_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("EpisodeCue", Some(ImmutablePropertiesMap::new(27, vec![("policy_score", Value::from(&data.policy_score)), ("projection_priority", Value::from(&data.projection_priority)), ("selected_count", Value::from(&data.selected_count)), ("contradiction_keys_json", Value::from(&data.contradiction_keys_json)), ("supporting_spans_json", Value::from(&data.supporting_spans_json)), ("surfaced_count", Value::from(&data.surfaced_count)), ("cue_version", Value::from(&data.cue_version)), ("temporal_markers_json", Value::from(&data.temporal_markers_json)), ("hit_count", Value::from(&data.hit_count)), ("salience_score", Value::from(&data.salience_score)), ("updated_at", Value::from(&data.updated_at)), ("projection_attempts", Value::from(&data.projection_attempts)), ("used_count", Value::from(&data.used_count)), ("route_reason", Value::from(&data.route_reason)), ("created_at", Value::from(&data.created_at)), ("quote_spans_json", Value::from(&data.quote_spans_json)), ("discourse_class", Value::from(&data.discourse_class)), ("group_id", Value::from(&data.group_id)), ("last_feedback_at", Value::from(&data.last_feedback_at)), ("projection_state", Value::from(&data.projection_state)), ("near_miss_count", Value::from(&data.near_miss_count)), ("episode_id", Value::from(&data.episode_id)), ("cue_text", Value::from(&data.cue_text)), ("last_hit_at", Value::from(&data.last_hit_at)), ("cue_score", Value::from(&data.cue_score)), ("last_projected_at", Value::from(&data.last_projected_at)), ("first_spans_json", Value::from(&data.first_spans_json))].into_iter(), &arena)), Some(&["episode_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegionEdge", Some(ImmutablePropertiesMap::new(7, vec![("target_region_id", Value::from(&data.target_region_id)), ("group_id", Value::from(&data.group_id)), ("relationship_count", Value::from(&data.relationship_count)), ("source_region_id", Value::from(&data.source_region_id)), ("edge_id", Value::from(&data.edge_id)), ("weight", Value::from(&data.weight)), ("snapshot_id", Value::from(&data.snapshot_id))].into_iter(), &arena)), Some(&["snapshot_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "GraphEmbedVec", Some(ImmutablePropertiesMap::new(4, vec![("model_version", Value::from(data.model_version.clone())), ("method", Value::from(data.method.clone())), ("group_id", Value::from(data.group_id.clone())), ("entity_id", Value::from(data.entity_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDreamAssociation", Some(ImmutablePropertiesMap::new(14, vec![("group_id", Value::from(&data.group_id)), ("source_entity_id", Value::from(&data.source_entity_id)), ("target_domain", Value::from(&data.target_domain)), ("target_entity_name", Value::from(&data.target_entity_name)), ("timestamp", Value::from(&data.timestamp)), ("relationship_id", Value::from(&data.relationship_id)), ("assoc_id", Value::from(&data.assoc_id)), ("embedding_similarity", Value::from(&data.embedding_similarity)), ("cycle_id", Value::from(&data.cycle_id)), ("target_entity_id", Value::from(&data.target_entity_id)), ("structural_proximity", Value::from(&data.structural_proximity)), ("surprise_score", Value::from(&data.surprise_score)), ("source_entity_name", Value::from(&data.source_entity_name)), ("source_domain", Value::from(&data.source_domain))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let chunk = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&__internal_embed_data_0, "EpisodeChunk", Some(ImmutablePropertiesMap::new(5, vec![("episode_id", Value::from(data.episode_id.clone())), ("chunk_index", Value::from(data.chunk_index.clone())), ("content_type", Value::from(data.content_type.clone())), ("chunk_text", Value::from(data.chunk_text.clone())), ("group_id", Value::from(data.group_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
