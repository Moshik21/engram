...
schema: Some(r#"{
  ...
  "queries": [
    ...
    {
      "name": "find_episodes_by_group_page",
      "parameters": {
        "gid": "String",
        "before": "String",
        "limit": "I64"
    ...
    {
      "name": "find_episode_by_episode_id",
      "parameters": {
        "eid": "String",
        "gid": "String"
      },
    ...
    {
      "name": "find_episodes_by_source_status_page",
      "parameters": {
        "limit": "I64",
        "before": "String",
        "st": "String",
    ...
    {
      "name": "find_episodes_by_source_page",
      "parameters": {
        "src": "String",
        "limit": "I64",
        "before": "String",
    ...
    {
      "name": "find_episodes_by_status_page",
      "parameters": {
        "gid": "String",
        "before": "String",
        "limit": "I64",
...
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "GraphEmbedVec", Some(ImmutablePropertiesMap::new(4, vec![("method", Value::from(data.method.clone())), ("group_id", Value::from(data.group_id.clone())), ("model_version", Value::from(data.model_version.clone())), ("entity_id", Value::from(data.entity_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
#[derive(Serialize, Deserialize, Clone)]
pub struct find_episodes_by_group_pageInput {
...
#[derive(Serialize, Default)]
pub struct Find_episodes_by_group_pageEpisodesReturnType<'a> {
    pub id: &'a str,
    pub label: &'a str,
    pub group_id: Option<&'a Value>,
    pub status: Option<&'a Value>,
...
#[handler]
pub fn find_episodes_by_group_page (input: HandlerInput) -> Result<Response, GraphError> {
let db = Arc::clone(&input.graph.storage);
let data = input.request.in_fmt.deserialize::<find_episodes_by_group_pageInput>(&input.request.body)?;
let arena = Bump::new();
let txn = db.graph_env.read_txn().map_err(|e| GraphError::New(format!("Failed to start read transaction: {:?}", e)))?;
...
.filter_ref(|val, txn|{
                if let Ok(val) = val {
                    ...
                    .map_or(false, |v| *v < data.before.clone())))
                } else {
                    Ok(false)
                }
            })

.order_by_desc(|val| val.get_property("created_at").cloned().unwrap_or(Value::Empty))

.range(0, data.limit.clone()).collect::<Result<Vec<_>, _>>()?;
let response = json!({
    "episodes": episodes.iter().map(|episode| Find_episodes_by_group_pageEpisodesReturnType {
...
.add_n("ConsolMerge", Some(ImmutablePropertiesMap::new(13, vec![("relationships_transferred", Value::from(&data.relationships_transferred)), ("keep_id", Value::from(&data.keep_id)), ("remove_id", Value::from(&data.remove_id)), ("remove_name", Value::from(&data.remove_name)), ("decision_reason", Value::from(&data.decision_reason)), ("timestamp", Value::from(&data.timestamp)), ("decision_source", Value::from(&data.decision_source)), ("decision_confidence", Value::from(&data.decision_confidence)), ("keep_name", Value::from(&data.keep_name)), ("merge_id", Value::from(&data.merge_id)), ("similarity", Value::from(&data.similarity)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolMaturation", Some(ImmutablePropertiesMap::new(13, vec![("entity_name", Value::from(&data.entity_name)), ("temporal_span_days", Value::from(&data.temporal_span_days)), ("access_regularity", Value::from(&data.access_regularity)), ("relationship_richness", Value::from(&data.relationship_richness)), ("entity_id", Value::from(&data.entity_id)), ("group_id", Value::from(&data.group_id)), ("old_tier", Value::from(&data.old_tier)), ("new_tier", Value::from(&data.new_tier)), ("maturity_score", Value::from(&data.maturity_score)), ("mat_id", Value::from(&data.mat_id)), ("cycle_id", Value::from(&data.cycle_id)), ("source_diversity", Value::from(&data.source_diversity)), ("timestamp", Value::from(&data.timestamp))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Conversation", Some(ImmutablePropertiesMap::new(6, vec![("created_at", Value::from(&data.created_at)), ("updated_at", Value::from(&data.updated_at)), ("title", Value::from(&data.title)), ("session_date", Value::from(&data.session_date)), ("group_id", Value::from(&data.group_id)), ("conversation_id", Value::from(&data.conversation_id))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolTriage", Some(ImmutablePropertiesMap::new(8, vec![("group_id", Value::from(&data.group_id)), ("triage_id", Value::from(&data.triage_id)), ("timestamp", Value::from(&data.timestamp)), ("episode_id", Value::from(&data.episode_id)), ("score_breakdown_json", Value::from(&data.score_breakdown_json)), ("decision", Value::from(&data.decision)), ("score", Value::from(&data.score)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDreamAssociation", Some(ImmutablePropertiesMap::new(14, vec![("structural_proximity", Value::from(&data.structural_proximity)), ("cycle_id", Value::from(&data.cycle_id)), ("source_domain", Value::from(&data.source_domain)), ("target_domain", Value::from(&data.target_domain)), ("source_entity_id", Value::from(&data.source_entity_id)), ("group_id", Value::from(&data.group_id)), ("source_entity_name", Value::from(&data.source_entity_name)), ("target_entity_name", Value::from(&data.target_entity_name)), ("assoc_id", Value::from(&data.assoc_id)), ("surprise_score", Value::from(&data.surprise_score)), ("timestamp", Value::from(&data.timestamp)), ("target_entity_id", Value::from(&data.target_entity_id)), ("embedding_similarity", Value::from(&data.embedding_similarity)), ("relationship_id", Value::from(&data.relationship_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolPrune", Some(ImmutablePropertiesMap::new(8, vec![("entity_type", Value::from(&data.entity_type)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("entity_id", Value::from(&data.entity_id)), ("timestamp", Value::from(&data.timestamp)), ("prune_id", Value::from(&data.prune_id)), ("reason", Value::from(&data.reason)), ("entity_name", Value::from(&data.entity_name))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Episode", Some(ImmutablePropertiesMap::new(22, vec![("projection_state", Value::from(&data.projection_state)), ("attachments_json", Value::from(&data.attachments_json)), ("error", Value::from(&data.error)), ("last_projected_at", Value::from(&data.last_projected_at)), ("group_id", Value::from(&data.group_id)), ("source", Value::from(&data.source)), ("status", Value::from(&data.status)), ("encoding_context_json", Value::from(&data.encoding_context_json)), ("conversation_date", Value::from(&data.conversation_date)), ("last_projection_reason", Value::from(&data.last_projection_reason)), ("processing_duration_ms", Value::from(&data.processing_duration_ms)), ("skipped_triage", Value::from(&data.skipped_triage)), ("memory_tier", Value::from(&data.memory_tier)), ("episode_id", Value::from(&data.episode_id)), ("session_id", Value::from(&data.session_id)), ("content", Value::from(&data.content)), ("updated_at", Value::from(&data.updated_at)), ("created_at", Value::from(&data.created_at)), ("skipped_meta", Value::from(&data.skipped_meta)), ("consolidation_cycles", Value::from(&data.consolidation_cycles)), ("entity_coverage", Value::from(&data.entity_coverage)), ("retry_count", Value::from(&data.retry_count))].into_iter(), &arena)), Some(&["group_id", "status", "session_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegionMember", Some(ImmutablePropertiesMap::new(4, vec![("snapshot_id", Value::from(&data.snapshot_id)), ("region_id", Value::from(&data.region_id)), ("entity_id", Value::from(&data.entity_id)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["snapshot_id", "group_id", "region_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolSchema", Some(ImmutablePropertiesMap::new(9, vec![("timestamp", Value::from(&data.timestamp)), ("predicate_count", Value::from(&data.predicate_count)), ("cycle_id", Value::from(&data.cycle_id)), ("schema_entity_id", Value::from(&data.schema_entity_id)), ("action", Value::from(&data.action)), ("group_id", Value::from(&data.group_id)), ("schema_id", Value::from(&data.schema_id)), ("instance_count", Value::from(&data.instance_count)), ("schema_name", Value::from(&data.schema_name))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolCalibration", Some(ImmutablePropertiesMap::new(14, vec![("oracle_examples", Value::from(&data.oracle_examples)), ("summary_json", Value::from(&data.summary_json)), ("timestamp", Value::from(&data.timestamp)), ("window_cycles", Value::from(&data.window_cycles)), ("total_traces", Value::from(&data.total_traces)), ("accuracy", Value::from(&data.accuracy)), ("abstain_count", Value::from(&data.abstain_count)), ("calibration_id", Value::from(&data.calibration_id)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("phase", Value::from(&data.phase)), ("labeled_examples", Value::from(&data.labeled_examples)), ("mean_confidence", Value::from(&data.mean_confidence)), ("expected_calibration_error", Value::from(&data.expected_calibration_error))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegionEdge", Some(ImmutablePropertiesMap::new(7, vec![("relationship_count", Value::from(&data.relationship_count)), ("snapshot_id", Value::from(&data.snapshot_id)), ("target_region_id", Value::from(&data.target_region_id)), ("edge_id", Value::from(&data.edge_id)), ("weight", Value::from(&data.weight)), ("group_id", Value::from(&data.group_id)), ("source_region_id", Value::from(&data.source_region_id))].into_iter(), &arena)), Some(&["snapshot_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
#[derive(Serialize, Deserialize, Clone)]
pub struct find_episode_by_episode_idInput {

pub eid: String,
pub gid: String
}
#[derive(Serialize, Default)]
pub struct Find_episode_by_episode_idEpisodesReturnType<'a> {
    pub id: &'a str,
    pub label: &'a str,
    pub group_id: Option<&'a Value>,
    pub status: Option<&'a Value>,
...
#[handler]
pub fn find_episode_by_episode_id (input: HandlerInput) -> Result<Response, GraphError> {
let db = Arc::clone(&input.graph.storage);
let data = input.request.in_fmt.deserialize::<find_episode_by_episode_idInput>(&input.request.body)?;
let arena = Bump::new();
let txn = db.graph_env.read_txn().map_err(|e| GraphError::New(format!("Failed to start read transaction: {:?}", e)))?;
    let episodes = G::new(&db, &txn, &arena)
.n_from_type("Episode")
...
.filter_ref(|val, txn|{
                if let Ok(val) = val {
                    ...
                    .map_or(false, |v| *v == data.gid.clone()) && val
                    .get_property("episode_id")
                    .map_or(false, |v| *v == data.eid.clone())))
                } else {
                    Ok(false)
                }
            }).collect::<Result<Vec<_>, _>>()?;
let response = json!({
    "episodes": episodes.iter().map(|episode| Find_episode_by_episode_idEpisodesReturnType {
        id: uuid_str(episode.id(), &arena),
        label: episode.label(),
        group_id: episode.get_property("group_id"),
        status: episode.get_property("status"),
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolSemanticTransition", Some(ImmutablePropertiesMap::new(9, vec![("group_id", Value::from(&data.group_id)), ("timestamp", Value::from(&data.timestamp)), ("trans_id", Value::from(&data.trans_id)), ("new_tier", Value::from(&data.new_tier)), ("entity_coverage", Value::from(&data.entity_coverage)), ("cycle_id", Value::from(&data.cycle_id)), ("old_tier", Value::from(&data.old_tier)), ("consolidation_cycles", Value::from(&data.consolidation_cycles)), ("episode_id", Value::from(&data.episode_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConversationMessage", Some(ImmutablePropertiesMap::new(6, vec![("created_at", Value::from(&data.created_at)), ("role", Value::from(&data.role)), ("message_id", Value::from(&data.message_id)), ("conversation_id", Value::from(&data.conversation_id)), ("content", Value::from(&data.content)), ("parts_json", Value::from(&data.parts_json))].into_iter(), &arena)), Some(&["conversation_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "CueVec", Some(ImmutablePropertiesMap::new(3, vec![("content_type", Value::from(data.content_type.clone())), ("group_id", Value::from(data.group_id.clone())), ("episode_id", Value::from(data.episode_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasSnapshot", Some(ImmutablePropertiesMap::new(13, vec![("total_relationships", Value::from(&data.total_relationships)), ("snapshot_id", Value::from(&data.snapshot_id)), ("displayed_edge_count", Value::from(&data.displayed_edge_count)), ("generated_at", Value::from(&data.generated_at)), ("displayed_node_count", Value::from(&data.displayed_node_count)), ("represented_edge_count", Value::from(&data.represented_edge_count)), ("total_entities", Value::from(&data.total_entities)), ("fastest_growing_region_id", Value::from(&data.fastest_growing_region_id)), ("truncated", Value::from(&data.truncated)), ("hottest_region_id", Value::from(&data.hottest_region_id)), ("total_regions", Value::from(&data.total_regions)), ("group_id", Value::from(&data.group_id)), ("represented_entity_count", Value::from(&data.represented_entity_count))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ComplementTag", Some(ImmutablePropertiesMap::new(10, vec![("target_id", Value::from(&data.target_id)), ("score", Value::from(&data.score)), ("created_at", Value::from(&data.created_at)), ("target_type", Value::from(&data.target_type)), ("tag_type", Value::from(&data.tag_type)), ("group_id", Value::from(&data.group_id)), ("updated_at", Value::from(&data.updated_at)), ("cycle_confirmed", Value::from(&data.cycle_confirmed)), ("cleared", Value::from(&data.cleared)), ("cycle_tagged", Value::from(&data.cycle_tagged))].into_iter(), &arena)), Some(&["target_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolReindex", Some(ImmutablePropertiesMap::new(7, vec![("group_id", Value::from(&data.group_id)), ("reindex_id", Value::from(&data.reindex_id)), ("entity_name", Value::from(&data.entity_name)), ("timestamp", Value::from(&data.timestamp)), ("source_phase", Value::from(&data.source_phase)), ("cycle_id", Value::from(&data.cycle_id)), ("entity_id", Value::from(&data.entity_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Entity", Some(ImmutablePropertiesMap::new(24, vec![("name", Value::from(&data.name)), ("deleted_at", Value::from(&data.deleted_at)), ("entity_id", Value::from(&data.entity_id)), ("created_at", Value::from(&data.created_at)), ("summary", Value::from(&data.summary)), ("is_deleted", Value::from(&data.is_deleted)), ("updated_at", Value::from(&data.updated_at)), ("evidence_count", Value::from(&data.evidence_count)), ("pii_detected", Value::from(&data.pii_detected)), ("entity_type", Value::from(&data.entity_type)), ("evidence_span_start", Value::from(&data.evidence_span_start)), ("group_id", Value::from(&data.group_id)), ("source_episode_ids", Value::from(&data.source_episode_ids)), ("access_count", Value::from(&data.access_count)), ("identity_core", Value::from(&data.identity_core)), ("canonical_identifier", Value::from(&data.canonical_identifier)), ("attributes_json", Value::from(&data.attributes_json)), ("lexical_regime", Value::from(&data.lexical_regime)), ("last_accessed", Value::from(&data.last_accessed)), ("identifier_label", Value::from(&data.identifier_label)), ("recon_count", Value::from(&data.recon_count)), ("pii_categories_json", Value::from(&data.pii_categories_json)), ("evidence_span_end", Value::from(&data.evidence_span_end)), ("mat_tier", Value::from(&data.mat_tier))].into_iter(), &arena)), Some(&["name", "group_id", "entity_type", "canonical_identifier"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let chunk = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "EpisodeChunk", Some(ImmutablePropertiesMap::new(5, vec![("episode_id", Value::from(data.episode_id.clone())), ("chunk_text", Value::from(data.chunk_text.clone())), ("chunk_index", Value::from(data.chunk_index.clone())), ("group_id", Value::from(data.group_id.clone())), ("content_type", Value::from(data.content_type.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("EpisodeCue", Some(ImmutablePropertiesMap::new(27, vec![("contradiction_keys_json", Value::from(&data.contradiction_keys_json)), ("hit_count", Value::from(&data.hit_count)), ("near_miss_count", Value::from(&data.near_miss_count)), ("projection_state", Value::from(&data.projection_state)), ("used_count", Value::from(&data.used_count)), ("last_feedback_at", Value::from(&data.last_feedback_at)), ("updated_at", Value::from(&data.updated_at)), ("discourse_class", Value::from(&data.discourse_class)), ("cue_text", Value::from(&data.cue_text)), ("projection_priority", Value::from(&data.projection_priority)), ("salience_score", Value::from(&data.salience_score)), ("surfaced_count", Value::from(&data.surfaced_count)), ("first_spans_json", Value::from(&data.first_spans_json)), ("episode_id", Value::from(&data.episode_id)), ("policy_score", Value::from(&data.policy_score)), ("cue_score", Value::from(&data.cue_score)), ("route_reason", Value::from(&data.route_reason)), ("last_projected_at", Value::from(&data.last_projected_at)), ("cue_version", Value::from(&data.cue_version)), ("last_hit_at", Value::from(&data.last_hit_at)), ("created_at", Value::from(&data.created_at)), ("selected_count", Value::from(&data.selected_count)), ("projection_attempts", Value::from(&data.projection_attempts)), ("supporting_spans_json", Value::from(&data.supporting_spans_json)), ("group_id", Value::from(&data.group_id)), ("temporal_markers_json", Value::from(&data.temporal_markers_json)), ("quote_spans_json", Value::from(&data.quote_spans_json))].into_iter(), &arena)), Some(&["episode_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDistillation", Some(ImmutablePropertiesMap::new(16, vec![("metadata_json", Value::from(&data.metadata_json)), ("teacher_source", Value::from(&data.teacher_source)), ("student_decision", Value::from(&data.student_decision)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("correct", Value::from(&data.correct)), ("features_json", Value::from(&data.features_json)), ("timestamp", Value::from(&data.timestamp)), ("decision_trace_id", Value::from(&data.decision_trace_id)), ("teacher_label", Value::from(&data.teacher_label)), ("student_confidence", Value::from(&data.student_confidence)), ("distill_id", Value::from(&data.distill_id)), ("phase", Value::from(&data.phase)), ("candidate_type", Value::from(&data.candidate_type)), ("threshold_band", Value::from(&data.threshold_band)), ("candidate_id", Value::from(&data.candidate_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolInferredEdge", Some(ImmutablePropertiesMap::new(14, vec![("pmi_score", Value::from(&data.pmi_score)), ("llm_verdict", Value::from(&data.llm_verdict)), ("relationship_id", Value::from(&data.relationship_id)), ("cycle_id", Value::from(&data.cycle_id)), ("source_name", Value::from(&data.source_name)), ("co_occurrence_count", Value::from(&data.co_occurrence_count)), ("timestamp", Value::from(&data.timestamp)), ("target_name", Value::from(&data.target_name)), ("edge_id", Value::from(&data.edge_id)), ("confidence", Value::from(&data.confidence)), ("source_id", Value::from(&data.source_id)), ("infer_type", Value::from(&data.infer_type)), ("group_id", Value::from(&data.group_id)), ("target_id", Value::from(&data.target_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
#[derive(Serialize, Deserialize, Clone)]
pub struct find_episodes_by_source_status_pageInput {
...
#[derive(Serialize, Default)]
pub struct Find_episodes_by_source_status_pageEpisodesReturnType<'a> {
    pub id: &'a str,
    pub label: &'a str,
    pub group_id: Option<&'a Value>,
    pub status: Option<&'a Value>,
...
#[handler]
pub fn find_episodes_by_source_status_page (input: HandlerInput) -> Result<Response, GraphError> {
let db = Arc::clone(&input.graph.storage);
let data = input.request.in_fmt.deserialize::<find_episodes_by_source_status_pageInput>(&input.request.body)?;
let arena = Bump::new();
let txn = db.graph_env.read_txn().map_err(|e| GraphError::New(format!("Failed to start read transaction: {:?}", e)))?;
    let episodes = G::new(&db, &txn, &arena)
.n_from_type("Episode")
...
.filter_ref(|val, txn|{
                if let Ok(val) = val {
                    ...
                    .map_or(false, |v| *v == data.gid.clone()) && val
                    .get_property("source")
                    .map_or(false, |v| *v == data.src.clone()) && val
                    .get_property("status")
                    .map_or(false, |v| *v == data.st.clone()) && val
                    .get_property("created_at")
                    .map_or(false, |v| *v < data.before.clone())))
                } else {
                    Ok(false)
...
.range(0, data.limit.clone()).collect::<Result<Vec<_>, _>>()?;
let response = json!({
    "episodes": episodes.iter().map(|episode| Find_episodes_by_source_status_pageEpisodesReturnType {
        id: uuid_str(episode.id(), &arena),
        label: episode.label(),
        group_id: episode.get_property("group_id"),
        status: episode.get_property("status"),
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolReplay", Some(ImmutablePropertiesMap::new(9, vec![("entities_updated", Value::from(&data.entities_updated)), ("group_id", Value::from(&data.group_id)), ("timestamp", Value::from(&data.timestamp)), ("replay_id", Value::from(&data.replay_id)), ("episode_id", Value::from(&data.episode_id)), ("new_entities_found", Value::from(&data.new_entities_found)), ("skipped_reason", Value::from(&data.skipped_reason)), ("new_relationships_found", Value::from(&data.new_relationships_found)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
#[derive(Serialize, Deserialize, Clone)]
pub struct find_episodes_by_source_pageInput {
...
#[derive(Serialize, Default)]
pub struct Find_episodes_by_source_pageEpisodesReturnType<'a> {
    pub id: &'a str,
    pub label: &'a str,
    pub group_id: Option<&'a Value>,
    pub status: Option<&'a Value>,
...
#[handler]
pub fn find_episodes_by_source_page (input: HandlerInput) -> Result<Response, GraphError> {
let db = Arc::clone(&input.graph.storage);
let data = input.request.in_fmt.deserialize::<find_episodes_by_source_pageInput>(&input.request.body)?;
let arena = Bump::new();
let txn = db.graph_env.read_txn().map_err(|e| GraphError::New(format!("Failed to start read transaction: {:?}", e)))?;
    let episodes = G::new(&db, &txn, &arena)
.n_from_type("Episode")
...
.range(0, data.limit.clone()).collect::<Result<Vec<_>, _>>()?;
let response = json!({
    "episodes": episodes.iter().map(|episode| Find_episodes_by_source_pageEpisodesReturnType {
        id: uuid_str(episode.id(), &arena),
        label: episode.label(),
        group_id: episode.get_property("group_id"),
        status: episode.get_property("status"),
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Evidence", Some(ImmutablePropertiesMap::new(19, vec![("fact_class", Value::from(&data.fact_class)), ("payload_json", Value::from(&data.payload_json)), ("ambiguity_tags_json", Value::from(&data.ambiguity_tags_json)), ("adjudication_request_id", Value::from(&data.adjudication_request_id)), ("status", Value::from(&data.status)), ("group_id", Value::from(&data.group_id)), ("committed_id", Value::from(&data.committed_id)), ("evidence_id", Value::from(&data.evidence_id)), ("ambiguity_score", Value::from(&data.ambiguity_score)), ("resolved_at", Value::from(&data.resolved_at)), ("deferred_cycles", Value::from(&data.deferred_cycles)), ("source_span", Value::from(&data.source_span)), ("episode_id", Value::from(&data.episode_id)), ("confidence", Value::from(&data.confidence)), ("created_at", Value::from(&data.created_at)), ("commit_reason", Value::from(&data.commit_reason)), ("extractor_name", Value::from(&data.extractor_name)), ("signals_json", Value::from(&data.signals_json)), ("source_type", Value::from(&data.source_type))].into_iter(), &arena)), Some(&["episode_id", "group_id", "status"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDream", Some(ImmutablePropertiesMap::new(8, vec![("weight_delta", Value::from(&data.weight_delta)), ("dream_id", Value::from(&data.dream_id)), ("source_entity_id", Value::from(&data.source_entity_id)), ("timestamp", Value::from(&data.timestamp)), ("group_id", Value::from(&data.group_id)), ("cycle_id", Value::from(&data.cycle_id)), ("seed_entity_id", Value::from(&data.seed_entity_id)), ("target_entity_id", Value::from(&data.target_entity_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolEvidenceAdj", Some(ImmutablePropertiesMap::new(8, vec![("adj_id", Value::from(&data.adj_id)), ("timestamp", Value::from(&data.timestamp)), ("evidence_id", Value::from(&data.evidence_id)), ("action", Value::from(&data.action)), ("new_confidence", Value::from(&data.new_confidence)), ("group_id", Value::from(&data.group_id)), ("reason", Value::from(&data.reason)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("SchemaMember", Some(ImmutablePropertiesMap::new(4, vec![("group_id", Value::from(&data.group_id)), ("schema_entity_id", Value::from(&data.schema_entity_id)), ("member_entity_id", Value::from(&data.member_entity_id)), ("role_label", Value::from(&data.role_label))].into_iter(), &arena)), Some(&["schema_entity_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "EntityVec", Some(ImmutablePropertiesMap::new(5, vec![("content_type", Value::from(data.content_type.clone())), ("entity_id", Value::from(data.entity_id.clone())), ("embed_provider", Value::from(data.embed_provider.clone())), ("group_id", Value::from(data.group_id.clone())), ("embed_model", Value::from(data.embed_model.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolIdentifierReview", Some(ImmutablePropertiesMap::new(20, vec![("raw_similarity", Value::from(&data.raw_similarity)), ("entity_a_name", Value::from(&data.entity_a_name)), ("adjusted_similarity", Value::from(&data.adjusted_similarity)), ("entity_b_type", Value::from(&data.entity_b_type)), ("entity_b_regime", Value::from(&data.entity_b_regime)), ("group_id", Value::from(&data.group_id)), ("canonical_identifier_a", Value::from(&data.canonical_identifier_a)), ("entity_b_id", Value::from(&data.entity_b_id)), ("decision_source", Value::from(&data.decision_source)), ("entity_a_id", Value::from(&data.entity_a_id)), ("cycle_id", Value::from(&data.cycle_id)), ("canonical_identifier_b", Value::from(&data.canonical_identifier_b)), ("metadata_json", Value::from(&data.metadata_json)), ("review_id", Value::from(&data.review_id)), ("entity_a_regime", Value::from(&data.entity_a_regime)), ("review_status", Value::from(&data.review_status)), ("timestamp", Value::from(&data.timestamp)), ("entity_a_type", Value::from(&data.entity_a_type)), ("entity_b_name", Value::from(&data.entity_b_name)), ("decision_reason", Value::from(&data.decision_reason))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolCycle", Some(ImmutablePropertiesMap::new(10, vec![("completed_at", Value::from(&data.completed_at)), ("dry_run", Value::from(&data.dry_run)), ("status", Value::from(&data.status)), ("cycle_id", Value::from(&data.cycle_id)), ("phase_results_json", Value::from(&data.phase_results_json)), ("trigger", Value::from(&data.trigger)), ("total_duration_ms", Value::from(&data.total_duration_ms)), ("error", Value::from(&data.error)), ("started_at", Value::from(&data.started_at)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDecisionTrace", Some(ImmutablePropertiesMap::new(15, vec![("candidate_type", Value::from(&data.candidate_type)), ("constraints_json", Value::from(&data.constraints_json)), ("metadata_json", Value::from(&data.metadata_json)), ("group_id", Value::from(&data.group_id)), ("candidate_id", Value::from(&data.candidate_id)), ("policy_version", Value::from(&data.policy_version)), ("decision", Value::from(&data.decision)), ("trace_id", Value::from(&data.trace_id)), ("features_json", Value::from(&data.features_json)), ("threshold_band", Value::from(&data.threshold_band)), ("decision_source", Value::from(&data.decision_source)), ("cycle_id", Value::from(&data.cycle_id)), ("confidence", Value::from(&data.confidence)), ("timestamp", Value::from(&data.timestamp)), ("phase", Value::from(&data.phase))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Intention", Some(ImmutablePropertiesMap::new(13, vec![("updated_at", Value::from(&data.updated_at)), ("group_id", Value::from(&data.group_id)), ("is_deleted", Value::from(&data.is_deleted)), ("created_at", Value::from(&data.created_at)), ("entity_names_json", Value::from(&data.entity_names_json)), ("context_json", Value::from(&data.context_json)), ("enabled", Value::from(&data.enabled)), ("action_text", Value::from(&data.action_text)), ("intention_id", Value::from(&data.intention_id)), ("trigger_text", Value::from(&data.trigger_text)), ("fire_count", Value::from(&data.fire_count)), ("max_fires", Value::from(&data.max_fires)), ("deleted_at", Value::from(&data.deleted_at))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegion", Some(ImmutablePropertiesMap::new(18, vec![("growth_7d", Value::from(&data.growth_7d)), ("z", Value::from(&data.z)), ("latest_entity_created_at", Value::from(&data.latest_entity_created_at)), ("represented_edge_count", Value::from(&data.represented_edge_count)), ("hub_entity_ids_json", Value::from(&data.hub_entity_ids_json)), ("kind", Value::from(&data.kind)), ("x", Value::from(&data.x)), ("snapshot_id", Value::from(&data.snapshot_id)), ("dominant_entity_types_json", Value::from(&data.dominant_entity_types_json)), ("center_entity_id", Value::from(&data.center_entity_id)), ("region_id", Value::from(&data.region_id)), ("growth_30d", Value::from(&data.growth_30d)), ("subtitle", Value::from(&data.subtitle)), ("y", Value::from(&data.y)), ("region_label", Value::from(&data.region_label)), ("member_count", Value::from(&data.member_count)), ("group_id", Value::from(&data.group_id)), ("activation_score", Value::from(&data.activation_score))].into_iter(), &arena)), Some(&["snapshot_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolGraphEmbed", Some(ImmutablePropertiesMap::new(9, vec![("timestamp", Value::from(&data.timestamp)), ("training_duration_ms", Value::from(&data.training_duration_ms)), ("group_id", Value::from(&data.group_id)), ("cycle_id", Value::from(&data.cycle_id)), ("embed_id", Value::from(&data.embed_id)), ("entities_trained", Value::from(&data.entities_trained)), ("dimensions", Value::from(&data.dimensions)), ("full_retrain", Value::from(&data.full_retrain)), ("method", Value::from(&data.method))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "EpisodeVec", Some(ImmutablePropertiesMap::new(3, vec![("group_id", Value::from(data.group_id.clone())), ("content_type", Value::from(data.content_type.clone())), ("episode_id", Value::from(data.episode_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let edge = G::new_mut(&db, &arena, &mut txn)
.add_edge("RelatesTo", Some(ImmutablePropertiesMap::new(10, vec![("created_at", Value::from(data.created_at.clone())), ("polarity", Value::from(data.polarity.clone())), ("weight", Value::from(data.weight.clone())), ("valid_from", Value::from(data.valid_from.clone())), ("source_episode_id", Value::from(data.source_episode_id.clone())), ("valid_to", Value::from(data.valid_to.clone())), ("group_id", Value::from(data.group_id.clone())), ("predicate", Value::from(data.predicate.clone())), ("rel_id", Value::from(data.rel_id.clone())), ("is_expired", Value::from(data.is_expired.clone()))].into_iter(), &arena)), *data.source_id, *data.target_id, false, false).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolMicroglia", Some(ImmutablePropertiesMap::new(10, vec![("timestamp", Value::from(&data.timestamp)), ("tag_type", Value::from(&data.tag_type)), ("microglia_id", Value::from(&data.microglia_id)), ("score", Value::from(&data.score)), ("target_type", Value::from(&data.target_type)), ("target_id", Value::from(&data.target_id)), ("action", Value::from(&data.action)), ("group_id", Value::from(&data.group_id)), ("cycle_id", Value::from(&data.cycle_id)), ("detail", Value::from(&data.detail))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDecisionOutcome", Some(ImmutablePropertiesMap::new(10, vec![("outcome_id", Value::from(&data.outcome_id)), ("decision_trace_id", Value::from(&data.decision_trace_id)), ("outcome_label", Value::from(&data.outcome_label)), ("phase", Value::from(&data.phase)), ("outcome_type", Value::from(&data.outcome_type)), ("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("outcome_value", Value::from(&data.outcome_value)), ("metadata_json", Value::from(&data.metadata_json))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
#[derive(Serialize, Deserialize, Clone)]
pub struct find_episodes_by_status_pageInput {
...
#[derive(Serialize, Default)]
pub struct Find_episodes_by_status_pageEpisodesReturnType<'a> {
    pub id: &'a str,
    pub label: &'a str,
    pub group_id: Option<&'a Value>,
    pub status: Option<&'a Value>,
...
#[handler]
pub fn find_episodes_by_status_page (input: HandlerInput) -> Result<Response, GraphError> {
let db = Arc::clone(&input.graph.storage);
let data = input.request.in_fmt.deserialize::<find_episodes_by_status_pageInput>(&input.request.body)?;
let arena = Bump::new();
let txn = db.graph_env.read_txn().map_err(|e| GraphError::New(format!("Failed to start read transaction: {:?}", e)))?;
    let episodes = G::new(&db, &txn, &arena)
.n_from_type("Episode")
...
.range(0, data.limit.clone()).collect::<Result<Vec<_>, _>>()?;
let response = json!({
    "episodes": episodes.iter().map(|episode| Find_episodes_by_status_pageEpisodesReturnType {
        id: uuid_str(episode.id(), &arena),
        label: episode.label(),
        group_id: episode.get_property("group_id"),
        status: episode.get_property("status"),
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AdjudicationRequest", Some(ImmutablePropertiesMap::new(13, vec![("resolved_at", Value::from(&data.resolved_at)), ("request_reason", Value::from(&data.request_reason)), ("ambiguity_tags_json", Value::from(&data.ambiguity_tags_json)), ("created_at", Value::from(&data.created_at)), ("request_id", Value::from(&data.request_id)), ("episode_id", Value::from(&data.episode_id)), ("status", Value::from(&data.status)), ("group_id", Value::from(&data.group_id)), ("evidence_ids_json", Value::from(&data.evidence_ids_json)), ("resolution_source", Value::from(&data.resolution_source)), ("resolution_payload_json", Value::from(&data.resolution_payload_json)), ("selected_text", Value::from(&data.selected_text)), ("attempt_count", Value::from(&data.attempt_count))].into_iter(), &arena)), Some(&["episode_id", "group_id", "status"])).collect_to_obj()?;
let response = json!({
