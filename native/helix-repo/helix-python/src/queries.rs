...
.add_n("ConsolMicroglia", Some(ImmutablePropertiesMap::new(10, vec![("group_id", Value::from(&data.group_id)), ("tag_type", Value::from(&data.tag_type)), ("score", Value::from(&data.score)), ("action", Value::from(&data.action)), ("target_id", Value::from(&data.target_id)), ("timestamp", Value::from(&data.timestamp)), ("target_type", Value::from(&data.target_type)), ("detail", Value::from(&data.detail)), ("microglia_id", Value::from(&data.microglia_id)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolGraphEmbed", Some(ImmutablePropertiesMap::new(9, vec![("entities_trained", Value::from(&data.entities_trained)), ("embed_id", Value::from(&data.embed_id)), ("group_id", Value::from(&data.group_id)), ("method", Value::from(&data.method)), ("full_retrain", Value::from(&data.full_retrain)), ("dimensions", Value::from(&data.dimensions)), ("cycle_id", Value::from(&data.cycle_id)), ("timestamp", Value::from(&data.timestamp)), ("training_duration_ms", Value::from(&data.training_duration_ms))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolCalibration", Some(ImmutablePropertiesMap::new(14, vec![("calibration_id", Value::from(&data.calibration_id)), ("mean_confidence", Value::from(&data.mean_confidence)), ("phase", Value::from(&data.phase)), ("oracle_examples", Value::from(&data.oracle_examples)), ("labeled_examples", Value::from(&data.labeled_examples)), ("group_id", Value::from(&data.group_id)), ("timestamp", Value::from(&data.timestamp)), ("summary_json", Value::from(&data.summary_json)), ("total_traces", Value::from(&data.total_traces)), ("accuracy", Value::from(&data.accuracy)), ("window_cycles", Value::from(&data.window_cycles)), ("cycle_id", Value::from(&data.cycle_id)), ("expected_calibration_error", Value::from(&data.expected_calibration_error)), ("abstain_count", Value::from(&data.abstain_count))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolPrune", Some(ImmutablePropertiesMap::new(8, vec![("reason", Value::from(&data.reason)), ("entity_id", Value::from(&data.entity_id)), ("entity_name", Value::from(&data.entity_name)), ("prune_id", Value::from(&data.prune_id)), ("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id)), ("entity_type", Value::from(&data.entity_type)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDream", Some(ImmutablePropertiesMap::new(8, vec![("timestamp", Value::from(&data.timestamp)), ("dream_id", Value::from(&data.dream_id)), ("source_entity_id", Value::from(&data.source_entity_id)), ("weight_delta", Value::from(&data.weight_delta)), ("group_id", Value::from(&data.group_id)), ("seed_entity_id", Value::from(&data.seed_entity_id)), ("target_entity_id", Value::from(&data.target_entity_id)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Intention", Some(ImmutablePropertiesMap::new(13, vec![("fire_count", Value::from(&data.fire_count)), ("is_deleted", Value::from(&data.is_deleted)), ("group_id", Value::from(&data.group_id)), ("context_json", Value::from(&data.context_json)), ("deleted_at", Value::from(&data.deleted_at)), ("intention_id", Value::from(&data.intention_id)), ("entity_names_json", Value::from(&data.entity_names_json)), ("action_text", Value::from(&data.action_text)), ("trigger_text", Value::from(&data.trigger_text)), ("created_at", Value::from(&data.created_at)), ("max_fires", Value::from(&data.max_fires)), ("enabled", Value::from(&data.enabled)), ("updated_at", Value::from(&data.updated_at))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
.add_edge("RelatesTo", Some(ImmutablePropertiesMap::new(10, vec![("created_at", Value::from(data.created_at.clone())), ("source_episode_id", Value::from(data.source_episode_id.clone())), ("weight", Value::from(data.weight.clone())), ("is_expired", Value::from(data.is_expired.clone())), ("predicate", Value::from(data.predicate.clone())), ("valid_from", Value::from(data.valid_from.clone())), ("group_id", Value::from(data.group_id.clone())), ("rel_id", Value::from(data.rel_id.clone())), ("polarity", Value::from(data.polarity.clone())), ("valid_to", Value::from(data.valid_to.clone()))].into_iter(), &arena)), *data.source_id, *data.target_id, false, false).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolMerge", Some(ImmutablePropertiesMap::new(13, vec![("remove_id", Value::from(&data.remove_id)), ("relationships_transferred", Value::from(&data.relationships_transferred)), ("decision_reason", Value::from(&data.decision_reason)), ("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id)), ("decision_confidence", Value::from(&data.decision_confidence)), ("merge_id", Value::from(&data.merge_id)), ("decision_source", Value::from(&data.decision_source)), ("keep_name", Value::from(&data.keep_name)), ("remove_name", Value::from(&data.remove_name)), ("similarity", Value::from(&data.similarity)), ("group_id", Value::from(&data.group_id)), ("keep_id", Value::from(&data.keep_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolTriage", Some(ImmutablePropertiesMap::new(8, vec![("group_id", Value::from(&data.group_id)), ("episode_id", Value::from(&data.episode_id)), ("score_breakdown_json", Value::from(&data.score_breakdown_json)), ("triage_id", Value::from(&data.triage_id)), ("cycle_id", Value::from(&data.cycle_id)), ("score", Value::from(&data.score)), ("timestamp", Value::from(&data.timestamp)), ("decision", Value::from(&data.decision))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolEvidenceAdj", Some(ImmutablePropertiesMap::new(8, vec![("evidence_id", Value::from(&data.evidence_id)), ("new_confidence", Value::from(&data.new_confidence)), ("adj_id", Value::from(&data.adj_id)), ("group_id", Value::from(&data.group_id)), ("action", Value::from(&data.action)), ("reason", Value::from(&data.reason)), ("timestamp", Value::from(&data.timestamp)), ("cycle_id", Value::from(&data.cycle_id))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ComplementTag", Some(ImmutablePropertiesMap::new(10, vec![("cycle_tagged", Value::from(&data.cycle_tagged)), ("cycle_confirmed", Value::from(&data.cycle_confirmed)), ("updated_at", Value::from(&data.updated_at)), ("tag_type", Value::from(&data.tag_type)), ("score", Value::from(&data.score)), ("target_id", Value::from(&data.target_id)), ("group_id", Value::from(&data.group_id)), ("created_at", Value::from(&data.created_at)), ("cleared", Value::from(&data.cleared)), ("target_type", Value::from(&data.target_type))].into_iter(), &arena)), Some(&["target_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Episode", Some(ImmutablePropertiesMap::new(22, vec![("group_id", Value::from(&data.group_id)), ("projection_state", Value::from(&data.projection_state)), ("processing_duration_ms", Value::from(&data.processing_duration_ms)), ("entity_coverage", Value::from(&data.entity_coverage)), ("last_projected_at", Value::from(&data.last_projected_at)), ("updated_at", Value::from(&data.updated_at)), ("content", Value::from(&data.content)), ("status", Value::from(&data.status)), ("skipped_meta", Value::from(&data.skipped_meta)), ("skipped_triage", Value::from(&data.skipped_triage)), ("episode_id", Value::from(&data.episode_id)), ("last_projection_reason", Value::from(&data.last_projection_reason)), ("encoding_context_json", Value::from(&data.encoding_context_json)), ("consolidation_cycles", Value::from(&data.consolidation_cycles)), ("memory_tier", Value::from(&data.memory_tier)), ("created_at", Value::from(&data.created_at)), ("session_id", Value::from(&data.session_id)), ("source", Value::from(&data.source)), ("attachments_json", Value::from(&data.attachments_json)), ("retry_count", Value::from(&data.retry_count)), ("error", Value::from(&data.error)), ("conversation_date", Value::from(&data.conversation_date))].into_iter(), &arena)), Some(&["group_id", "status", "session_id"])).collect_to_obj()?;
let response = json!({
...
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "EntityVec", Some(ImmutablePropertiesMap::new(5, vec![("embed_provider", Value::from(data.embed_provider.clone())), ("content_type", Value::from(data.content_type.clone())), ("group_id", Value::from(data.group_id.clone())), ("entity_id", Value::from(data.entity_id.clone())), ("embed_model", Value::from(data.embed_model.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConversationMessage", Some(ImmutablePropertiesMap::new(6, vec![("message_id", Value::from(&data.message_id)), ("parts_json", Value::from(&data.parts_json)), ("conversation_id", Value::from(&data.conversation_id)), ("created_at", Value::from(&data.created_at)), ("content", Value::from(&data.content)), ("role", Value::from(&data.role))].into_iter(), &arena)), Some(&["conversation_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Evidence", Some(ImmutablePropertiesMap::new(19, vec![("group_id", Value::from(&data.group_id)), ("resolved_at", Value::from(&data.resolved_at)), ("created_at", Value::from(&data.created_at)), ("confidence", Value::from(&data.confidence)), ("source_type", Value::from(&data.source_type)), ("status", Value::from(&data.status)), ("payload_json", Value::from(&data.payload_json)), ("adjudication_request_id", Value::from(&data.adjudication_request_id)), ("extractor_name", Value::from(&data.extractor_name)), ("commit_reason", Value::from(&data.commit_reason)), ("fact_class", Value::from(&data.fact_class)), ("committed_id", Value::from(&data.committed_id)), ("source_span", Value::from(&data.source_span)), ("episode_id", Value::from(&data.episode_id)), ("ambiguity_score", Value::from(&data.ambiguity_score)), ("ambiguity_tags_json", Value::from(&data.ambiguity_tags_json)), ("evidence_id", Value::from(&data.evidence_id)), ("deferred_cycles", Value::from(&data.deferred_cycles)), ("signals_json", Value::from(&data.signals_json))].into_iter(), &arena)), Some(&["episode_id", "group_id", "status"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "CueVec", Some(ImmutablePropertiesMap::new(3, vec![("group_id", Value::from(data.group_id.clone())), ("content_type", Value::from(data.content_type.clone())), ("episode_id", Value::from(data.episode_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDecisionTrace", Some(ImmutablePropertiesMap::new(15, vec![("threshold_band", Value::from(&data.threshold_band)), ("features_json", Value::from(&data.features_json)), ("decision", Value::from(&data.decision)), ("group_id", Value::from(&data.group_id)), ("confidence", Value::from(&data.confidence)), ("metadata_json", Value::from(&data.metadata_json)), ("candidate_type", Value::from(&data.candidate_type)), ("timestamp", Value::from(&data.timestamp)), ("phase", Value::from(&data.phase)), ("candidate_id", Value::from(&data.candidate_id)), ("cycle_id", Value::from(&data.cycle_id)), ("policy_version", Value::from(&data.policy_version)), ("trace_id", Value::from(&data.trace_id)), ("decision_source", Value::from(&data.decision_source)), ("constraints_json", Value::from(&data.constraints_json))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let v = G::new_mut(&db, &arena, &mut txn)
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&data.vec, "GraphEmbedVec", Some(ImmutablePropertiesMap::new(4, vec![("model_version", Value::from(data.model_version.clone())), ("method", Value::from(data.method.clone())), ("entity_id", Value::from(data.entity_id.clone())), ("group_id", Value::from(data.group_id.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegionMember", Some(ImmutablePropertiesMap::new(4, vec![("entity_id", Value::from(&data.entity_id)), ("snapshot_id", Value::from(&data.snapshot_id)), ("group_id", Value::from(&data.group_id)), ("region_id", Value::from(&data.region_id))].into_iter(), &arena)), Some(&["snapshot_id", "group_id", "region_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegion", Some(ImmutablePropertiesMap::new(18, vec![("z", Value::from(&data.z)), ("kind", Value::from(&data.kind)), ("group_id", Value::from(&data.group_id)), ("dominant_entity_types_json", Value::from(&data.dominant_entity_types_json)), ("hub_entity_ids_json", Value::from(&data.hub_entity_ids_json)), ("center_entity_id", Value::from(&data.center_entity_id)), ("growth_30d", Value::from(&data.growth_30d)), ("region_label", Value::from(&data.region_label)), ("region_id", Value::from(&data.region_id)), ("snapshot_id", Value::from(&data.snapshot_id)), ("x", Value::from(&data.x)), ("y", Value::from(&data.y)), ("represented_edge_count", Value::from(&data.represented_edge_count)), ("activation_score", Value::from(&data.activation_score)), ("latest_entity_created_at", Value::from(&data.latest_entity_created_at)), ("growth_7d", Value::from(&data.growth_7d)), ("subtitle", Value::from(&data.subtitle)), ("member_count", Value::from(&data.member_count))].into_iter(), &arena)), Some(&["snapshot_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasSnapshot", Some(ImmutablePropertiesMap::new(13, vec![("generated_at", Value::from(&data.generated_at)), ("truncated", Value::from(&data.truncated)), ("total_entities", Value::from(&data.total_entities)), ("represented_edge_count", Value::from(&data.represented_edge_count)), ("displayed_node_count", Value::from(&data.displayed_node_count)), ("displayed_edge_count", Value::from(&data.displayed_edge_count)), ("group_id", Value::from(&data.group_id)), ("total_regions", Value::from(&data.total_regions)), ("represented_entity_count", Value::from(&data.represented_entity_count)), ("total_relationships", Value::from(&data.total_relationships)), ("fastest_growing_region_id", Value::from(&data.fastest_growing_region_id)), ("snapshot_id", Value::from(&data.snapshot_id)), ("hottest_region_id", Value::from(&data.hottest_region_id))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolReindex", Some(ImmutablePropertiesMap::new(7, vec![("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("source_phase", Value::from(&data.source_phase)), ("entity_id", Value::from(&data.entity_id)), ("timestamp", Value::from(&data.timestamp)), ("reindex_id", Value::from(&data.reindex_id)), ("entity_name", Value::from(&data.entity_name))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolSemanticTransition", Some(ImmutablePropertiesMap::new(9, vec![("consolidation_cycles", Value::from(&data.consolidation_cycles)), ("new_tier", Value::from(&data.new_tier)), ("trans_id", Value::from(&data.trans_id)), ("group_id", Value::from(&data.group_id)), ("old_tier", Value::from(&data.old_tier)), ("entity_coverage", Value::from(&data.entity_coverage)), ("episode_id", Value::from(&data.episode_id)), ("cycle_id", Value::from(&data.cycle_id)), ("timestamp", Value::from(&data.timestamp))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
.insert_v::<fn(&HVector, &RoTxn) -> bool>(&__internal_embed_data_0, "EpisodeChunk", Some(ImmutablePropertiesMap::new(5, vec![("episode_id", Value::from(data.episode_id.clone())), ("group_id", Value::from(data.group_id.clone())), ("chunk_index", Value::from(data.chunk_index.clone())), ("content_type", Value::from(data.content_type.clone())), ("chunk_text", Value::from(data.chunk_text.clone()))].into_iter(), &arena))).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("SchemaMember", Some(ImmutablePropertiesMap::new(4, vec![("member_entity_id", Value::from(&data.member_entity_id)), ("schema_entity_id", Value::from(&data.schema_entity_id)), ("role_label", Value::from(&data.role_label)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["schema_entity_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDecisionOutcome", Some(ImmutablePropertiesMap::new(10, vec![("outcome_value", Value::from(&data.outcome_value)), ("timestamp", Value::from(&data.timestamp)), ("outcome_type", Value::from(&data.outcome_type)), ("decision_trace_id", Value::from(&data.decision_trace_id)), ("metadata_json", Value::from(&data.metadata_json)), ("cycle_id", Value::from(&data.cycle_id)), ("outcome_id", Value::from(&data.outcome_id)), ("outcome_label", Value::from(&data.outcome_label)), ("group_id", Value::from(&data.group_id)), ("phase", Value::from(&data.phase))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Conversation", Some(ImmutablePropertiesMap::new(6, vec![("title", Value::from(&data.title)), ("created_at", Value::from(&data.created_at)), ("conversation_id", Value::from(&data.conversation_id)), ("updated_at", Value::from(&data.updated_at)), ("session_date", Value::from(&data.session_date)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolInferredEdge", Some(ImmutablePropertiesMap::new(14, vec![("cycle_id", Value::from(&data.cycle_id)), ("confidence", Value::from(&data.confidence)), ("source_id", Value::from(&data.source_id)), ("relationship_id", Value::from(&data.relationship_id)), ("co_occurrence_count", Value::from(&data.co_occurrence_count)), ("pmi_score", Value::from(&data.pmi_score)), ("edge_id", Value::from(&data.edge_id)), ("source_name", Value::from(&data.source_name)), ("llm_verdict", Value::from(&data.llm_verdict)), ("group_id", Value::from(&data.group_id)), ("target_name", Value::from(&data.target_name)), ("infer_type", Value::from(&data.infer_type)), ("target_id", Value::from(&data.target_id)), ("timestamp", Value::from(&data.timestamp))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolReplay", Some(ImmutablePropertiesMap::new(9, vec![("new_relationships_found", Value::from(&data.new_relationships_found)), ("group_id", Value::from(&data.group_id)), ("cycle_id", Value::from(&data.cycle_id)), ("new_entities_found", Value::from(&data.new_entities_found)), ("timestamp", Value::from(&data.timestamp)), ("entities_updated", Value::from(&data.entities_updated)), ("episode_id", Value::from(&data.episode_id)), ("replay_id", Value::from(&data.replay_id)), ("skipped_reason", Value::from(&data.skipped_reason))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDreamAssociation", Some(ImmutablePropertiesMap::new(14, vec![("embedding_similarity", Value::from(&data.embedding_similarity)), ("source_domain", Value::from(&data.source_domain)), ("source_entity_name", Value::from(&data.source_entity_name)), ("group_id", Value::from(&data.group_id)), ("relationship_id", Value::from(&data.relationship_id)), ("timestamp", Value::from(&data.timestamp)), ("surprise_score", Value::from(&data.surprise_score)), ("structural_proximity", Value::from(&data.structural_proximity)), ("assoc_id", Value::from(&data.assoc_id)), ("cycle_id", Value::from(&data.cycle_id)), ("source_entity_id", Value::from(&data.source_entity_id)), ("target_domain", Value::from(&data.target_domain)), ("target_entity_id", Value::from(&data.target_entity_id)), ("target_entity_name", Value::from(&data.target_entity_name))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("Entity", Some(ImmutablePropertiesMap::new(24, vec![("identifier_label", Value::from(&data.identifier_label)), ("last_accessed", Value::from(&data.last_accessed)), ("evidence_count", Value::from(&data.evidence_count)), ("updated_at", Value::from(&data.updated_at)), ("pii_detected", Value::from(&data.pii_detected)), ("entity_type", Value::from(&data.entity_type)), ("entity_id", Value::from(&data.entity_id)), ("recon_count", Value::from(&data.recon_count)), ("mat_tier", Value::from(&data.mat_tier)), ("source_episode_ids", Value::from(&data.source_episode_ids)), ("evidence_span_start", Value::from(&data.evidence_span_start)), ("created_at", Value::from(&data.created_at)), ("canonical_identifier", Value::from(&data.canonical_identifier)), ("summary", Value::from(&data.summary)), ("name", Value::from(&data.name)), ("identity_core", Value::from(&data.identity_core)), ("pii_categories_json", Value::from(&data.pii_categories_json)), ("deleted_at", Value::from(&data.deleted_at)), ("access_count", Value::from(&data.access_count)), ("lexical_regime", Value::from(&data.lexical_regime)), ("evidence_span_end", Value::from(&data.evidence_span_end)), ("attributes_json", Value::from(&data.attributes_json)), ("is_deleted", Value::from(&data.is_deleted)), ("group_id", Value::from(&data.group_id))].into_iter(), &arena)), Some(&["name", "group_id", "entity_type", "canonical_identifier"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolSchema", Some(ImmutablePropertiesMap::new(9, vec![("schema_entity_id", Value::from(&data.schema_entity_id)), ("instance_count", Value::from(&data.instance_count)), ("schema_id", Value::from(&data.schema_id)), ("schema_name", Value::from(&data.schema_name)), ("cycle_id", Value::from(&data.cycle_id)), ("group_id", Value::from(&data.group_id)), ("action", Value::from(&data.action)), ("timestamp", Value::from(&data.timestamp)), ("predicate_count", Value::from(&data.predicate_count))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AtlasRegionEdge", Some(ImmutablePropertiesMap::new(7, vec![("group_id", Value::from(&data.group_id)), ("relationship_count", Value::from(&data.relationship_count)), ("edge_id", Value::from(&data.edge_id)), ("target_region_id", Value::from(&data.target_region_id)), ("weight", Value::from(&data.weight)), ("source_region_id", Value::from(&data.source_region_id)), ("snapshot_id", Value::from(&data.snapshot_id))].into_iter(), &arena)), Some(&["snapshot_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolMaturation", Some(ImmutablePropertiesMap::new(13, vec![("old_tier", Value::from(&data.old_tier)), ("relationship_richness", Value::from(&data.relationship_richness)), ("cycle_id", Value::from(&data.cycle_id)), ("temporal_span_days", Value::from(&data.temporal_span_days)), ("entity_id", Value::from(&data.entity_id)), ("maturity_score", Value::from(&data.maturity_score)), ("source_diversity", Value::from(&data.source_diversity)), ("access_regularity", Value::from(&data.access_regularity)), ("mat_id", Value::from(&data.mat_id)), ("new_tier", Value::from(&data.new_tier)), ("group_id", Value::from(&data.group_id)), ("timestamp", Value::from(&data.timestamp)), ("entity_name", Value::from(&data.entity_name))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("EpisodeCue", Some(ImmutablePropertiesMap::new(27, vec![("discourse_class", Value::from(&data.discourse_class)), ("hit_count", Value::from(&data.hit_count)), ("selected_count", Value::from(&data.selected_count)), ("salience_score", Value::from(&data.salience_score)), ("last_hit_at", Value::from(&data.last_hit_at)), ("first_spans_json", Value::from(&data.first_spans_json)), ("cue_score", Value::from(&data.cue_score)), ("surfaced_count", Value::from(&data.surfaced_count)), ("quote_spans_json", Value::from(&data.quote_spans_json)), ("last_projected_at", Value::from(&data.last_projected_at)), ("group_id", Value::from(&data.group_id)), ("cue_version", Value::from(&data.cue_version)), ("episode_id", Value::from(&data.episode_id)), ("projection_attempts", Value::from(&data.projection_attempts)), ("near_miss_count", Value::from(&data.near_miss_count)), ("supporting_spans_json", Value::from(&data.supporting_spans_json)), ("created_at", Value::from(&data.created_at)), ("projection_priority", Value::from(&data.projection_priority)), ("last_feedback_at", Value::from(&data.last_feedback_at)), ("policy_score", Value::from(&data.policy_score)), ("cue_text", Value::from(&data.cue_text)), ("temporal_markers_json", Value::from(&data.temporal_markers_json)), ("projection_state", Value::from(&data.projection_state)), ("contradiction_keys_json", Value::from(&data.contradiction_keys_json)), ("route_reason", Value::from(&data.route_reason)), ("updated_at", Value::from(&data.updated_at)), ("used_count", Value::from(&data.used_count))].into_iter(), &arena)), Some(&["episode_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolCycle", Some(ImmutablePropertiesMap::new(10, vec![("completed_at", Value::from(&data.completed_at)), ("total_duration_ms", Value::from(&data.total_duration_ms)), ("error", Value::from(&data.error)), ("started_at", Value::from(&data.started_at)), ("status", Value::from(&data.status)), ("cycle_id", Value::from(&data.cycle_id)), ("dry_run", Value::from(&data.dry_run)), ("group_id", Value::from(&data.group_id)), ("phase_results_json", Value::from(&data.phase_results_json)), ("trigger", Value::from(&data.trigger))].into_iter(), &arena)), Some(&["group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolIdentifierReview", Some(ImmutablePropertiesMap::new(20, vec![("cycle_id", Value::from(&data.cycle_id)), ("entity_a_name", Value::from(&data.entity_a_name)), ("canonical_identifier_b", Value::from(&data.canonical_identifier_b)), ("adjusted_similarity", Value::from(&data.adjusted_similarity)), ("entity_b_id", Value::from(&data.entity_b_id)), ("decision_reason", Value::from(&data.decision_reason)), ("entity_b_regime", Value::from(&data.entity_b_regime)), ("entity_a_regime", Value::from(&data.entity_a_regime)), ("review_status", Value::from(&data.review_status)), ("decision_source", Value::from(&data.decision_source)), ("entity_b_type", Value::from(&data.entity_b_type)), ("entity_a_id", Value::from(&data.entity_a_id)), ("metadata_json", Value::from(&data.metadata_json)), ("canonical_identifier_a", Value::from(&data.canonical_identifier_a)), ("raw_similarity", Value::from(&data.raw_similarity)), ("review_id", Value::from(&data.review_id)), ("entity_b_name", Value::from(&data.entity_b_name)), ("timestamp", Value::from(&data.timestamp)), ("group_id", Value::from(&data.group_id)), ("entity_a_type", Value::from(&data.entity_a_type))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("ConsolDistillation", Some(ImmutablePropertiesMap::new(16, vec![("candidate_id", Value::from(&data.candidate_id)), ("phase", Value::from(&data.phase)), ("teacher_source", Value::from(&data.teacher_source)), ("student_decision", Value::from(&data.student_decision)), ("decision_trace_id", Value::from(&data.decision_trace_id)), ("threshold_band", Value::from(&data.threshold_band)), ("student_confidence", Value::from(&data.student_confidence)), ("teacher_label", Value::from(&data.teacher_label)), ("distill_id", Value::from(&data.distill_id)), ("candidate_type", Value::from(&data.candidate_type)), ("features_json", Value::from(&data.features_json)), ("correct", Value::from(&data.correct)), ("cycle_id", Value::from(&data.cycle_id)), ("timestamp", Value::from(&data.timestamp)), ("group_id", Value::from(&data.group_id)), ("metadata_json", Value::from(&data.metadata_json))].into_iter(), &arena)), Some(&["cycle_id", "group_id"])).collect_to_obj()?;
let response = json!({
...
let mut txn = db.graph_env.write_txn().map_err(|e| GraphError::New(format!("Failed to start write transaction: {:?}", e)))?;
    let node = G::new_mut(&db, &arena, &mut txn)
.add_n("AdjudicationRequest", Some(ImmutablePropertiesMap::new(13, vec![("selected_text", Value::from(&data.selected_text)), ("created_at", Value::from(&data.created_at)), ("group_id", Value::from(&data.group_id)), ("status", Value::from(&data.status)), ("resolution_source", Value::from(&data.resolution_source)), ("ambiguity_tags_json", Value::from(&data.ambiguity_tags_json)), ("episode_id", Value::from(&data.episode_id)), ("evidence_ids_json", Value::from(&data.evidence_ids_json)), ("attempt_count", Value::from(&data.attempt_count)), ("request_reason", Value::from(&data.request_reason)), ("request_id", Value::from(&data.request_id)), ("resolution_payload_json", Value::from(&data.resolution_payload_json)), ("resolved_at", Value::from(&data.resolved_at))].into_iter(), &arena)), Some(&["episode_id", "group_id", "status"])).collect_to_obj()?;
let response = json!({
